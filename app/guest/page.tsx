    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-extrabold text-gray-900">Available Events</h1>
        ...
        {events.length === 0 ? (
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {events.map((event) => (
              <div key={event.id} className="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <div className="text-sm font-medium text-gray-900">${event.price.toFixed(2)}</div>
                  </div>
                </div>
                <div className="px-4 py-4 sm:px-6">
                  <button
                    ...
                    className={`w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${bookingId === event.id ? 'opacity-75 cursor-not-allowed' : ''}`}
                  >
                    {bookingId === event.id ? (
                      <>
